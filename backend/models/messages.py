...
class Message(Document):
    ...
    replies = ListField(
        ReferenceField("self", reverse_delete_rule=PULL)
    )  # will delete all replies when a message is deleted
    parentMessage = LazyReferenceField("self", reverse_delete_rule=CASCADE)
